...
import { Mail, Phone, Shield, UserCheck, Pencil, Lock } from 'lucide-react';
...
export default function Profile() {
    ...
    const handleProfileSubmit = async (e) => {
        ...
        try {
            ...
            const res = await axios.patch('/api/user/auth/update', payload, {
      ...
      -------------------------------------------------- */}
            ...
            <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    ...
                    <p className="text-xs opacity-70">View and manage your account information.</p>
                </div>
      ...
      -------------------------------------------------- */}
          ...
          -------------------------------------------------- */}
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <span className="mt-1 rounded-full bg-blue-500/10 px-4 py-1 text-xs text-blue-500">Company xyz</span>
                    </div>
                    ...
                    <div className="w-full flex-1">
                        <div className="grid grid-cols-1 gap-6 text-xs md:grid-cols-2">
                            ...
                            <div className="border-app bg-surface rounded-xl border p-5">
                                ...
                                <p className="break-all opacity-70">{user?.email || '-'}</p>
                            </div>
                            ...
                            <div className="border-app bg-surface rounded-xl border p-5">
                                ...
                                <p className="capitalize opacity-70">{user?.roleId?.name || '-'}</p>
                            </div>
