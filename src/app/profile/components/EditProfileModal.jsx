...
export default function EditProfileModal({ isOpen, onClose, formData, onChange, onSubmit, saving }) {
    // --------------------------------------------------
    // Phone Input Handler
    // --------------------------------------------------
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} size="md">
            ...
            -------------------------------------------------- */}
                        ...
                        <Input label="Name" name="name" value={formData?.name || ''} onChange={onChange} placeholder="Enter your name" autoComplete="name" />
            ...
            -------------------------------------------------- */}
                        ...
                        <p className="text-[11px] opacity-60">Phone number must contain exactly 10 digits.</p>
                    </div>
                </Modal.Body>
