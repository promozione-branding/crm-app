        ...
        <div className="bg-surface text-app min-h-[calc(100vh-64px)] p-3 sm:p-4 md:p-6">
            ...
            <div className="bg-app border-app flex min-h-[calc(100vh-190px)] w-full items-center justify-center rounded-xl border px-4 py-10 sm:min-h-[400px] sm:rounded-2xl sm:px-6 sm:py-12">
                <div className="w-full max-w-md text-center">
                    ...
                    <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-blue-500/10 sm:mb-6 sm:h-20 sm:w-20">
                        <FileBarChart2 size={32} className="text-blue-500 sm:hidden" />

                        <FileBarChart2 size={40} className="hidden text-blue-500 sm:block" />
                    </div>
                    ...
                    <h2 className="mb-2 text-lg font-semibold sm:text-xl">No Reports Found</h2>
                    ...
                    <button
                        type="button"
                        className="btn-primary mt-5 h-10 rounded-xl px-4 text-sm font-medium shadow-sm transition-all hover:-translate-y-0.5 hover:shadow-md sm:mt-6 sm:px-5"
                    >
                        Generate Report
                    </button>
                </div>
