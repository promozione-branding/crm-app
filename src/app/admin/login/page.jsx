                ...
                <div className="w-full max-w-6xl bg-white rounded-3xl shadow-2xl overflow-hidden grid lg:grid-cols-2">
                    <div className="hidden lg:flex bg-linear-to-br from-[#082c62] via-[#0d376f] to-[#051f48] text-white p-8 flex-col">
                        <div>
                            ...
                            <h2 className="text-4xl font-bold leading-tight text-center">Welcome Back!</h2>

                            <p className="text-white/80 text-sm">Manage your InquiryBazaar platform, companies, teams and business.</p>
                        </div>
                        ...
                        <div className="space-y-6 mt-auto">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-white/70 text-sm">Create and manage client companies with complete control.</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-white/70 text-sm">Track platform growth, performance and activities.</p>
                                </div>
                            </div>
                        </div>
                    </div>
