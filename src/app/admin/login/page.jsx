        ...
        <>
            ...
            <header className="w-full border-b bg-white shadow-sm">
                <div className="mx-auto flex h-20 max-w-7xl items-center justify-center px-6">
                    <Image src="/logocheck.webp" alt="InquiryBazaar" width={240} height={70} priority />
                </div>
            </header>

            {/* Main */}
            <div className="flex min-h-[calc(100vh-80px)] items-center justify-center bg-slate-100 p-6">
                <div className="grid w-full max-w-6xl overflow-hidden rounded-3xl bg-white shadow-2xl lg:grid-cols-2">
                    <div className="hidden flex-col bg-linear-to-br from-[#082c62] via-[#0d376f] to-[#051f48] p-8 text-white lg:flex">
                        <div>
                            <div className="mb-4 flex items-center justify-center">
                                <Image src="/logoo.webp" alt="InquiryBazaar" width={250} height={50} className="rounded-2xl" />
                            </div>

                            <h2 className="text-center text-4xl leading-tight font-bold">Welcome Back!</h2>

                            <p className="text-sm text-white/80">Manage your InquiryBazaar platform, companies, teams and business.</p>
                        </div>
                        ...
                        <div className="mt-auto space-y-6">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-white/70">Create and manage client companies with complete control.</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-white/70">Track platform growth, performance and activities.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center justify-center p-4 lg:p-8">
                        <div className="w-full max-w-md">
                            <div className="mb-6 flex justify-center lg:hidden">
                                <Image src="/logocheck.webp" alt="InquiryBazaar" width={180} height={55} />
                            </div>

                            <div className="mb-8 text-center">
                                <h2 className="text-3xl font-bold text-gray-900">Welcome to InquiryBazaar</h2>
