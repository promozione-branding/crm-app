// src/app/api/user/lead/bulk-import/route.js
    ...
    try {
        ...
        for (let index = 0; index < rows.length; index++) {
            ...
            try {
                ...
                // Validate stage
                const allowedStages = ['new', 'contacted', 'qualified', 'proposal_sent', 'negotiation', 'won', 'lost'];
                ...
                // Validate source
                const allowedSources = ['facebook', 'google', 'website', 'whatsapp', 'manual', 'indiamart', 'tradeindia', 'other'];
                ...
                leads.push({
                    ...
                    gstNumber:
                        String(row.gstNumber || row['GST Number'] || '')
                            .trim()
