// src/app/api/user/meta/assets/route.js
...
export async function GET(request) {
    try {
        ...
        if (!pagesResponse.ok || pagesData.error) {
            ...
            return NextResponse.json({ success: false, message: 'Failed to fetch Facebook Pages', error: pagesData.error || null }, { status: 400 });
        }
        ...
        if (!adAccountsResponse.ok || adAccountsData.error) {
            ...
            return NextResponse.json({ success: false, message: 'Failed to fetch Meta Ad Accounts', error: adAccountsData.error || null }, { status: 400 });
        }
