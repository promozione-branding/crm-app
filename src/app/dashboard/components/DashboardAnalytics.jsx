            ...
            <section className="grid grid-cols-1 gap-4 lg:grid-cols-2">
                ...
                <div className="bg-app border-app rounded-2xl border p-4 sm:p-6">
                    ...
                    <div className="mb-5 flex items-center justify-between">
                        ...
                        <Link
                            href="/leads"
                            className="text-muted hover-app flex items-center gap-1 rounded-lg px-2 py-1 text-xs font-medium"
                        >
                            View all
                            <ArrowRight size={13} />
                        </Link>
                ...
                <div className="bg-app border-app rounded-2xl border p-4 sm:p-6">
                    ...
                    0 ? (
                        <EmptyState
                            ...
                            hint="Activity will appear here."
                        />
                    ) : (
                        <div className="space-y-3">
                    ...
                    <div className="space-y-3">
                        ...
                        {Object.entries(
                            ...
                            <EmptyState
                                ...
                                hint="Lead sources will appear here."
                            />
                        ) : (
                            Object.entries(
                                sources
            ...
            <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
                {[1, 2, 3, 4].map(
                    (item) => (
                        <div
                            key={item}
                            className="border-app h-20 animate-pulse rounded-xl border"
                        />
                    )
                )}
            </div>
            ...
            <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
                {[1, 2].map(
                    (item) => (
                        <div
                            key={item}
                            className="border-app h-80 animate-pulse rounded-2xl border"
                        />
                    )
                )}
            </div>
            ...
            <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
                {[1, 2].map(
                    (item) => (
                        <div
                            key={item}
                            className="border-app h-64 animate-pulse rounded-2xl border"
                        />
                    )
                )}
            </div>
