...
export default function DashboardAIChat() {
    ...
    const [messages, setMessages] = useState([
        {
            role: 'assistant',
            content:
                "Hi 👋 I'm your CRM AI. Ask me anything about your leads, calls, or tasks.",
        },
    ]);
    ...
    const send = async (textOverride) => {
        ...
        try {
            ...
            console.error(err);
            toast.error(
                err?.response?.data?.message || 'AI failed to reply.'
            );
        } finally {
            setSending(false);
        }
        ...
        <>
            ...
            {!open && (
                <button
                    ...
                    className="fixed bottom-20 right-4 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-violet-600 text-white shadow-lg transition hover:bg-violet-700 active:scale-95 sm:bottom-5 sm:right-5"
            ...
            ============================================== */}
            {open && (
                <div className="bg-app border-app fixed bottom-20 right-4 z-50 flex h-[min(560px,75vh)] w-[min(400px,92vw)] flex-col overflow-hidden rounded-2xl border shadow-2xl sm:bottom-5 sm:right-5 sm:h-[min(600px,85vh)]">
                    {/* HEADER */}
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <div>
                                ...
                                <p className="text-[11px] opacity-80">
                                    Ask about your leads, calls & tasks
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="border-t border-white/10 p-2.5">
                        <div className="border-app focus-within:border-violet-500 flex items-end gap-2 rounded-xl border px-3 py-2 transition">
                            <textarea
                                value={input}
                        ...
                        <p className="mt-1.5 px-1 text-[10px] opacity-50">
