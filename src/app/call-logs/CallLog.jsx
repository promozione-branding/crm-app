    ...
    return (
        <div className="bg-surface text-app min-h-[calc(100vh-64px)] p-6">
            ...
            <div className="mb-6">
                ...
                <p className="text-xs opacity-70">Call History</p>
            </div>
            ...
            <div className="bg-app border border-app rounded-2xl min-h-[400px] flex items-center justify-center">
                <div className="text-center max-w-md">
                    <div className="mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-full bg-green-500/10">
                        <PhoneOff size={40} className="text-green-500" />
                    </div>

                    <h2 className="text-xl font-semibold mb-2">No Call Logs Found</h2>
                    ...
                    <button className="mt-6 h-10 px-5 rounded-xl bg-green-600 text-white hover:bg-green-700 transition">Refresh</button>
                </div>
            </div>
        </div>
    );
