        ...
        <main className="min-h-screen bg-gradient-to-br from-white via-blue-50 to-purple-100">
            ...
            <section className="grid grid-cols-1 items-center gap-5 px-8 py-10 lg:grid-cols-2">
                ...
                <div className="flex flex-wrap justify-center gap-4 text-gray-600 lg:flex-nowrap">
                    ...
                    {/* Call Tracking */}
                    <div className="w-72 rounded-3xl bg-white shadow-2xl">
                        <div className="rounded-t-3xl bg-black px-6 py-4 font-semibold text-white">Call Tracking</div>
                    ...
                    {/* WhatsApp */}
                    <div className="w-72 rounded-3xl bg-white shadow-2xl">
                        <div className="rounded-t-3xl bg-green-500 px-6 py-4 font-semibold text-white">WhatsApp</div>

                        <div className="space-y-4 p-4 text-sm">
                            <div className="inline-block rounded-full bg-green-100 px-2 py-2 text-sm text-green-700">✓ Auto Follow-up Sent</div>

                            <div className="rounded-2xl bg-gray-100 p-2">Namaste! Saw your query for 2BHK in HSR...</div>

                            <div className="ml-auto w-fit rounded-2xl bg-green-100 p-2">Yes, share brochure 📎</div>

                            <div className="rounded-2xl bg-gray-100 p-2">Sending. Free to visit Saturday 11 AM?</div>

                            <div className="ml-auto w-fit rounded-2xl bg-green-100 px-2 py-2">Yes ✓✓</div>
                        </div>
                    </div>
                </div>
            </section>
