// src/controllers/user/userAuthController.js
...
export const loginUser = async (request) => {
    try {
        ...
        // JWT
        const token = jwt.sign({ id: user._id, role: user.role, email: user.email }, ENV.JWT_CLIENT_SECRET, { expiresIn: `${ENV.COOKIE_EXPIRE}d` });
