    ...
    return (
        <div className="space-y-5">
            <div className="flex items-center justify-between gap-3">
                <div>
                    <h2 className="text-base font-semibold text-app">Websites</h2>

                    <p className="text-xs text-muted mt-1">Connect your websites to capture leads and inquiries.</p>
                </div>
            ...
            <div className="min-h-[320px] rounded-2xl border border-dashed border-app bg-app flex flex-col items-center justify-center text-center px-6">
                ...
                <h3 className="text-sm font-semibold text-app">No website found</h3>
